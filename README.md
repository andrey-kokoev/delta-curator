...
- `POST /sources/processed-urls/reset` with JSON body containing `project_id` and `source_id` (authentication required)
...
- `POST /sources/processed-urls/reset` (clear per-source processed URL dedupe memory)
---
